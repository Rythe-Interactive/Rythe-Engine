...
#pragma endregion
    ...
    void setupCameraEntity()
    {
        ...
        groundplane.add_components<rendering::mesh_renderable>(mesh_filter(rendering::ModelCache::create_model("floor", "assets://models/groundplane.obj"_view).get_mesh()), groundmat );
