    ...
    virtual void setup()
    {
        ...
        app::window window = m_ecs->world.get_component_handle<app::window>().read();
        {
            ...
            //plane
            {
                ...
                ent.add_components<transform>(position(0, 7.0f, 0), rotation(math::angleAxis(math::pi<float>()*0.5f,math::vec3(1.0f,0.0f,0.0f))), scale());
            ...
            //floor
            {
                ...
                p.AddBox(physics::cube_collider_params(32.0f, -9.0f, 32.0f));
                ent.add_component(p);
            }
            ...
            //terminal
            {
                ...
                ent.add_components<transform>(position(10.0f, 5.0f, 10.0f), rotation(), scale(1));
                physics::physicsComponent p;
