...
// namespace sandbox
// {
//     [[rsl_reflect(rythe::system_function), maybe_unused]] static rsl::result<void> test_system(rythe::core::system_context& systemContext)
//     {
...
//             );
//
//             [[maybe_unused]] constexpr auto str = type_name<decltype(process_function(
//                     [](process_context<
//                             reads<transform /* archetype of: position, rotation, scale */, my_component>,
//                             writes<my_other_component>> context)
//             {
...
//             }))::process_context_info::reading_components>();
//
