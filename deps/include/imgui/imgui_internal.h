...
namespace ImGui
{
    ...
    //CHANGE(algorythmix) cppcheck complains about the adress of g.ForegroundDrawList being returned
    //Was:
    ...
    inline ImDrawList*      GetForegroundDrawList(ImGuiWindow* window) { IM_UNUSED(window); &(GImGui->ForegroundDrawList); }
