...
namespace legion::rendering
{
    ...
    public:
         ...
         */
        virtual void update(std::vector<ecs::entity>& particle_list, ecs::component<particle_emitter> particle_emitter, time::span delta_time) const LEGION_IMPURE;
