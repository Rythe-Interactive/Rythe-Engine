...
namespace legion::physics
{
        ...
        std::vector<physics_manifold_precursor>&& manifoldPrecursors)
    {
        ...
        for (auto& precursor : manifoldPrecursors)
        {
            ...
            else
            {
                ...
                m_entityOccupiedCells.emplace(id, std::unordered_set<math::int3>());
            }
...

            {
                ...
                std::unordered_set<math::int3> visitedCells;
    ...
    math::int3 BroadphaseUniformGrid::calculateCellIndex(const math::float3 point)
    {
