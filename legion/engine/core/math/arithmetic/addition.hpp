...
namespace legion::core::math
{
    ...
    template<typename _Scalar, size_type _Size>
    constexpr vector<_Scalar, _Size> add(const vector<_Scalar, _Size>& a, const vector<_Scalar, _Size>& b) noexcept
    {
        return detail::compute_addition<_Scalar, _Size>::compute(a, b);
    }
    ...
    template<typename _Scalar, size_type _Size>
    constexpr vector<_Scalar, _Size> add(const vector<_Scalar, _Size>& a, _Scalar b) noexcept
    {
        return detail::compute_addition<_Scalar, _Size>::compute(a, b);
    }
    ...
    template<typename _Scalar, size_type _Size>
    constexpr vector<_Scalar, _Size>& add_assign(vector<_Scalar, _Size>& a, const vector<_Scalar, _Size>& b) noexcept
    {
        return detail::compute_addition<_Scalar, _Size>::compute_assign(a, b);
    }
    ...
    template<typename _Scalar, size_type _Size>
    constexpr vector<_Scalar, _Size>& add_assign(vector<_Scalar, _Size>& a, _Scalar b) noexcept
    {
        return detail::compute_addition<_Scalar, _Size>::compute_assign(a, b);
    }
