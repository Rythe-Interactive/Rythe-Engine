...
namespace legion::core::math
{
    ...
    L_NODISCARD constexpr auto div(const vec_type0& a, const vec_type1& b) noexcept
    {
    ...
    L_NODISCARD constexpr auto div(const vec_type& a, typename vec_type::scalar b) noexcept
    {
