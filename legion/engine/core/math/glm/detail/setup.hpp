...
#define GLM_LANG_CXX2L_FLAG         (1 << 7)
...
#define GLM_LANG_CXX2A          (GLM_LANG_CXX17 | GLM_LANG_CXX2L_FLAG)
...
#   define GLM_CUDL_FUNC_DEF __device__ __host__
#   define GLM_CUDL_FUNC_DECL __device__ __host__
#else
#   define GLM_CUDL_FUNC_DEF
#   define GLM_CUDL_FUNC_DECL
#endif
...
#define GLM_FUNC_DECL GLM_CUDL_FUNC_DECL
#define GLM_FUNC_QUALIFIER GLM_CUDL_FUNC_DEF GLM_INLINE
...
namespace std {
    // Import SYCL's functions into the namespace legion::core::math::std to force their usages.
...
#       pragma message (GLM_STR(GLM_VERSION_MESSAGE))
    ...
    // Report C++ language
#   if (GLM_LANG & GLM_LANG_CXX2L_FLAG) && (GLM_LANG & GLM_LANG_EXT)
#       pragma message("GLM: C++ 2A with extensions")
#   elif (GLM_LANG & GLM_LANG_CXX2L_FLAG)
