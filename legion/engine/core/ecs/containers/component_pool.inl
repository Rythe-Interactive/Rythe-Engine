...
namespace legion::core::ecs
{
    ...
    template<typename component_type>
    inline L_ALWAYS_INLINE void* component_pool<component_type>::create_component(entity target, const void* src)
    {
        auto& ret = m_components.try_emplace(target, *static_cast<const component_type*>(src)).first.value();
