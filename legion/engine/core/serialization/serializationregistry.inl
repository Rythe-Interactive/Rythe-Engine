...
{
    std::map<id_type, std::unique_ptr<serializer_base<void*>>> Serialization_Registry::serializers;
    ...
    inline pointer<serializer_base<void*>> legion::core::serialization::Serialization_Registry::get_serializer(id_type id)
    {
