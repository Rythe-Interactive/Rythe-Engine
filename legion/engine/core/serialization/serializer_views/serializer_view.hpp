...
namespace legion::core::serialization
{
    struct serializer_view
    {
        ...
        L_NODISCARD bool serialize(const std::string& name, Type&& value);
        L_NODISCARD bool serialize(const std::string& name, const void* value, id_type typeId);
        ...
        L_NODISCARD common::result<void, fs_error> deserialize(const std::string& name, void* value, id_type typeId);
        ...
        L_NODISCARD virtual common::result<void, fs_error> start_read(const std::string& name) LEGION_PURE;
        L_NODISCARD virtual common::result<void, fs_error> peak_ahead(const std::string& name) LEGION_PURE;
        ...
        L_NODISCARD virtual common::result<void, fs_error> write(fs::view& file) LEGION_PURE;

        L_NODISCARD virtual common::result<void, fs_error> read(const fs::view& file) LEGION_PURE;
        L_NODISCARD virtual common::result<void, fs_error> read(const byte_vec& data) LEGION_PURE;
        L_NODISCARD virtual common::result<void, fs_error> read(byte_vec::iterator begin, byte_vec::iterator end) LEGION_PURE;
    };
}
