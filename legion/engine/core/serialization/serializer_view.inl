...
#pragma region json_view
    ...
    common::result<bool, fs_error> json_view::deserialize_bool(std::string& name)
    {
        return false/*data[name].get<bool>()*/;
    }
...
#pragma region bson_view
    ...
    common::result<bool, fs_error> bson_view::deserialize_bool(std::string& name)
    {
        return;
    }
...
#pragma region yaml_view
    ...
    common::result<bool, fs_error> yaml_view::deserialize_bool(std::string& name)
    {
        return;
    }
