...
namespace legion::core::assets
{
    ...
    template<typename AssetType>
    static common::result<asset<AssetType>> load(id_type nameHash, const fs::view& file);
    template<typename AssetType>
    static common::result<asset<AssetType>> load(id_type nameHash, const fs::view& file, const import_settings<AssetType>& settings);
    template<typename AssetType>
    ...
    template<typename AssetType>
    static async::async_operation<common::result<asset<AssetType>>> loadAsync(id_type nameHash, const fs::view& file);
    template<typename AssetType>
    static async::async_operation<common::result<asset<AssetType>>> loadAsync(id_type nameHash, const fs::view& file, const import_settings<AssetType>& settings);
    ...
    template<typename AssetType>
    static asset<AssetType> create(id_type nameHash);
    template<typename AssetType>
    static asset<AssetType> create(id_type nameHash, const AssetType& src);
    template<typename AssetType, typename... Arguments>
    static asset<AssetType> create(id_type nameHash, Arguments&&... args);

    template<typename AssetType>
    static asset<AssetType> exists(const std::string& name);
    template<typename AssetType>
    static asset<AssetType> exists(id_type nameHash);
