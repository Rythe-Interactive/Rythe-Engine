...
namespace args::application
{
    ...
    private:
        struct window_request
        {
            ...
            {}
            window_request(id_type entityId, math::ivec2 size = { 400, 400 }, const std::string& name = "<Args> Engine", image_handle icon = invalid_image_handle, GLFWmonitor* monitor = nullptr, GLFWwindow* share = nullptr, int swapInterval = 0)
...
#pragma endregion
    ...
    public:
        ...
        static void requestWindow(id_type entityId, math::ivec2 size = { 400, 400 }, const std::string& name = "<Args> Engine", image_handle icon = invalid_image_handle, GLFWmonitor* monitor = nullptr, GLFWwindow* share = nullptr, int swapInterval = 0);
