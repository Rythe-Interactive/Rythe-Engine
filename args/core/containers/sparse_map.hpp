...
namespace args::core
{
    ...
    public:
        ...
        A_NODISCARD iterator begin() { return iterator(m_dense_key.begin(), m_dense_value.begin()); }
        A_NODISCARD const_iterator begin() const { return const_iterator(m_dense_key.cbegin(), m_dense_value.cbegin()); }
        A_NODISCARD const_iterator cbegin() const { return const_iterator(m_dense_key.cbegin(), m_dense_value.cbegin()); }

        A_NODISCARD iterator end() { return iterator(m_dense_key.begin() + m_size, m_dense_value.begin() + m_size); }
        A_NODISCARD const_iterator end() const { return const_iterator(m_dense_key.cbegin() + m_size, m_dense_value.cbegin() + m_size); }
        A_NODISCARD const_iterator cend() const { return const_iterator(m_dense_key.cbegin() + m_size, m_dense_value.cbegin() + m_size); }
